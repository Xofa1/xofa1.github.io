...
;hljs.registerLanguage("csharp",e)})();/*! `glsl` grammar compiled for Highlight.js 11.9.0 */
...
className:"meta",begin:"#",end:"$"}]})})();hljs.registerLanguage("glsl",e)})();/*! `json` grammar compiled for Highlight.js 11.9.0 */
